...
use AHTCRUD\Blog\Api\Data;
use AHTCRUD\Blog\Api\PostRepositoryInterface;
use Magento\Framework\Api\SearchCriteria\CollectionProcessorInterface;
use Magento\Framework\Exception\CouldNotDeleteException;
use Magento\Framework\Exception\CouldNotSaveException;
use Magento\Framework\Exception\NoSuchEntityException;
use AHTCRUD\Blog\Model\ResourceModel\Post as ResourcePost;
use AHTCRUD\Blog\Model\ResourceModel\Post\CollectionFactory as PostCollectionFactory;
/**
...
class PostRepository implements PostRepositoryInterface
{
    ...
    public function getList()
    {
        ...
        /** @var \AHTCRUD\Blog\Model\ResourceModel\Post\Collection $collection */
        $collection = $this->PostCollectionFactory->create();

        // $collection->getSelect()
        //     ->joinleft('blog as item',
        //         'main_table.post_id=item.post_id', 
        //         array('main_table.*', 'count(item.blog_id) as sl',
        //         ))
